...
Address::Address(const std::string &ip, const uint16_t port) : Address() {
...
const sockaddr &Address::to_sockaddr() const { return addr_.as_sockaddr; }
